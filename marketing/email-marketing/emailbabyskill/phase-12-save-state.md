...
10. **Brand colours reference** — quick lookup table
...
This file enables: `/emailbaby <brand> resume`

## 12.2 Backward Compatibility

If resuming from a v3.0 state file (no Image Inventory, no Quality Score):
...
**Check 1 — Frame ID:**
1. Compare your production frame ID against the canonical Row 7 grid IDs:
...
7. Same ID + position validation for the Copy + Wireframe frame:
