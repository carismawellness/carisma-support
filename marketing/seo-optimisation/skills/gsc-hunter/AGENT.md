...
4. Check marketing/google-gmb/keywords_{brand}_auto_additions.json (for each brand)
...
For each brand with valid GSC data:
  ...
  → Call: marketing/seo-optimisation/tools/gsc_quick_win_finder.py functions
...
For each brand with new keywords:
  ...
  → Save to: marketing/google-gmb/keywords_{brand_id}_auto_additions.json
