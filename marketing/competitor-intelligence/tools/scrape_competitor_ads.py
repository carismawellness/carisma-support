...
Usage:
    python marketing/competitor-intelligence/tools/scrape_competitor_ads.py --brand_category all
    python marketing/competitor-intelligence/tools/scrape_competitor_ads.py --brand_category spa --dry_run
    python marketing/competitor-intelligence/tools/scrape_competitor_ads.py --brand_category aesthetics --output_dir .tmp/research/competitor-intel
