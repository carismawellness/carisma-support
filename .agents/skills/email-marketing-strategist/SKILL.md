...
| Design brief (structured markdown) | Email Designer via `/emaildesign <brand>` |
...
1. Load MCP tools: `ToolSearch: "+klaviyo"` to load Klaviyo tools
...
4. Output the brief and offer to delegate to Email Designer
...
| **Google Ads Specialist** | Coordinates messaging — email themes should align with search campaign keywords. |
