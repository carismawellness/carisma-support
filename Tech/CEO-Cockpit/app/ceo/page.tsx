...
const MOCK_SPA_REVENUE = [
  94998, 60568, 49599, 55589, 63111, 70994, 89422, 80348, 78251, 72287, 82943, 84696,
];
...
const MOCK_SPA_EBITDA = [
  35426, 17202, 8180, 12206, 14586, 19755, 32735, 27942, 28095, 22141, 28555, 33552,
];
const MOCK_AES_EBITDA = [
  4420, 21150, -5231, -5951, 10541, 7271, 1056, -4591, 11795, 12135, -2534, -5007,
];
