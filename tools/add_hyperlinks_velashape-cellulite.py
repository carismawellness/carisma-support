#!/usr/bin/env python3
"""
add_hyperlinks_velashape-cellulite.py

Applies internal hyperlinks to the Google Doc for:
[August 2026] VelaShape Anti-Cellulite Malta — Carisma Slimming

Doc ID: 1WcAiZZ0mjYzVYkCgn0MJoVjzjUyNWLE9sfMfCxUC3Bc
...
deletions don't shift earlier positions.

Usage:
    python3 tools/add_hyperlinks_velashape-cellulite.py
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1WcAiZZ0mjYzVYkCgn0MJoVjzjUyNWLE9sfMfCxUC3Bc",
        "title": "SLI-AUG-01 — VelaShape Anti-Cellulite Malta",
        "final_md": f"{BASE_DIR}/post-01-velashape-cellulite-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog -- Add Hyperlinks: VelaShape Anti-Cellulite Malta")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1WcAiZZ0mjYzVYkCgn0MJoVjzjUyNWLE9sfMfCxUC3Bc/edit")
