#!/usr/bin/env python3
"""
add_hyperlinks_prenatal-massage.py

Converts 'anchor text [→ URL]' visible link placeholders in the Prenatal Massage
Google Doc to real clickable hyperlinks using the Google Docs API batchUpdate.

Post: [August 2026] Prenatal Massage Malta — Carisma Spa
Doc ID: 1hfTydd6hpKVXGB6M5O0WGGMuipVOpMH-EB4zPhdO7sU
FINAL.md: .tmp/blog-drafts/spa/august-2026/post-02-prenatal-massage-FINAL.md
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1hfTydd6hpKVXGB6M5O0WGGMuipVOpMH-EB4zPhdO7sU",
        "title": "SPA-AUG-02 — Prenatal Massage Malta",
        "final_md": f"{BASE_DIR}/post-02-prenatal-massage-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Prenatal Massage Post")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1hfTydd6hpKVXGB6M5O0WGGMuipVOpMH-EB4zPhdO7sU/edit")
