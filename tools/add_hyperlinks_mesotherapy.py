#!/usr/bin/env python3
"""
add_hyperlinks_mesotherapy.py

Applies real hyperlinks to the Mesotherapy Malta blog post Google Doc.
Converts 'anchor text [→ URL]' visible link placeholders to real clickable hyperlinks.

Post: Mesotherapy Malta — AES-02 (July 2026)
Doc ID: 17UMZBWWmxwRG6zEWyXnRAIiHQA03mCa2qER5IZ2WHoQ
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "17UMZBWWmxwRG6zEWyXnRAIiHQA03mCa2qER5IZ2WHoQ",
        "title": "AES-02 — Mesotherapy Malta (July 2026)",
        "final_md": f"{BASE_DIR}/FINAL-02-mesotherapy-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Mesotherapy Malta (AES-02)")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/17UMZBWWmxwRG6zEWyXnRAIiHQA03mCa2qER5IZ2WHoQ/edit")
