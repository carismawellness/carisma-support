...
Reads FINAL.md files to extract (anchor_text, url) pairs, then finds
...
SPA_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/spa/aug-2026"
AES_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/aesthetics/august-2026"
SLI_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/slimming/august-2026"

DOCS_CONFIG = [
    # ─── Carisma Spa — August 2026 ───
    {
        "doc_id": "1TVJURwAwZcbSG99nnvuGhdfi_yrxFoHl_cOs1P5W1wM",
        "title": "SPA-01 — Reflexology Malta",
        "final_md": f"{SPA_DIR}/FINAL-01-reflexology-malta.md",
    },
    {
        "doc_id": "194g6hKNNuXLqaBhGRqB114ZI5X9aVRukxPumBElCbvw",
        "title": "SPA-02 — Aromatherapy Massage Malta",
        "final_md": f"{SPA_DIR}/FINAL-02-aromatherapy-massage-malta.md",
    },
    {
        "doc_id": "1AQ7flv1mOGlm36-WIhzUe8F-3G-nxL74W2u_q_Kx-v8",
        "title": "SPA-03 — Body Wrap Treatment Malta",
        "final_md": f"{SPA_DIR}/FINAL-03-body-wrap-treatment-malta.md",
    },
    {
        "doc_id": "18syEKwwrIb1DrYIUmtzNBdBy0fExSyQvYeo-ATU5dhM",
        "title": "SPA-04 — Spa for New Mums Malta",
        "final_md": f"{SPA_DIR}/FINAL-04-spa-for-new-mums-malta.md",
    },
    # ─── Carisma Aesthetics — August 2026 ───
    {
        "doc_id": "1fpXDJvnpCF43ylQ7Wdx9VEVk0GITcSuOdKtn1OsgP2c",
        "title": "AES-01 — Cheek Fillers Malta",
        "final_md": f"{AES_DIR}/FINAL-01-cheek-fillers-malta.md",
    },
    {
        "doc_id": "1OVhyMWphR9ColyTyfY3rU9wXQ_aIADl2wRCCTnK9vVI",
        "title": "AES-02 — RF Microneedling Malta",
        "final_md": f"{AES_DIR}/FINAL-02-rf-microneedling-malta.md",
    },
    {
        "doc_id": "1Boa-SJFK-1RirhnZNkB3-90OnJAITa7kUdOpHT5fyOk",
        "title": "AES-03 — Rosacea Treatment Malta",
        "final_md": f"{AES_DIR}/FINAL-03-rosacea-treatment-malta.md",
    },
    {
        "doc_id": "1qNbjVuK_Wa4pKXVvUfYlnzy72UZMPllZipHFDMzroU0",
        "title": "AES-04 — Non-Surgical Rhinoplasty Malta",
        "final_md": f"{AES_DIR}/FINAL-04-non-surgical-rhinoplasty-malta.md",
    },
    # ─── Carisma Slimming — August 2026 ───
    {
        "doc_id": "1R2Ky-Yr8w7PoHHVv7JcFBNk_glgUjrrrhwHIUvuguAM",
        "title": "SLI-01 — Anti-Cellulite Treatment Malta",
        "final_md": f"{SLI_DIR}/FINAL-01-anti-cellulite-treatment-malta.md",
    },
    {
        "doc_id": "1ExqLydjRMSC6jcGaq8SjpopYKSQx5__1mLBBzeA2z_Y",
        "title": "SLI-02 — Insulin Resistance Weight Loss Malta",
        "final_md": f"{SLI_DIR}/FINAL-02-insulin-resistance-weight-loss-malta.md",
    },
    {
        "doc_id": "1LhQhiBJyci-fSFAUKu2phikhfflAVzDU8YiAnnB4FAY",
        "title": "SLI-03 — Body Contouring Malta",
        "final_md": f"{SLI_DIR}/FINAL-03-body-contouring-malta.md",
    },
    {
        "doc_id": "157wsMmRRebzOHl_-WDp92kivic82dx35nL2kaiTUbYQ",
        "title": "SLI-04 — Emotional Eating Weight Loss Malta",
        "final_md": f"{SLI_DIR}/FINAL-04-emotional-eating-weight-loss-malta.md",
    },
]
...
def find_link_occurrences(flat_text, index_map, anchor, url):
    ...
    """
    # The Google Doc publisher writes: anchor text [→ url]
    # The → is Unicode U+2192
...
def process_doc(service, doc_id, title, final_md_path):
    ...
    # Deduplicate — the FINAL.md may link the same anchor+URL multiple times.
    # We collect unique pairs; find_link_occurrences will find ALL doc occurrences for each.
    seen = set()
    md_links = []
    ...
    # For each occurrence (highest first):
    #   a) Apply link style to anchor text (no text change, no position shift)
    #   b) Delete the suffix ' [→ url]' (shifts everything after it, but we've
    #      already handled higher-indexed items)
    requests = []
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks to Google Docs")
    print("=" * 60)
    ...
    print(f"\n{'=' * 60}")
    print("Complete. Open each Google Doc to verify hyperlinks are blue and clickable.")
