#!/usr/bin/env python3
"""
add_hyperlinks_chemical-peels.py

Applies real hyperlinks to the Chemical Peels Malta Google Doc.
Converts 'anchor text [→ URL]' placeholders to clickable links.

Doc: Chemical Peels Malta: The Complete Guide to Brighter, Clearer Skin | Carisma Aesthetics | July 2026
Doc ID: 1kS-gyVE-k9j4ocsxEYlnE2HDDJtI70CdV2Zmle6yAVY
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1kS-gyVE-k9j4ocsxEYlnE2HDDJtI70CdV2Zmle6yAVY",
        "title": "AES-04 (July 2026) — Chemical Peels Malta",
        "final_md": f"{BASE_DIR}/FINAL-04-chemical-peels-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Chemical Peels Malta — Add Hyperlinks")
    print("=" * 60)
