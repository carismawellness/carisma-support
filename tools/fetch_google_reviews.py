...
Usage:
    ...
    python tools/fetch_google_reviews.py --brand_id carisma_spa --days_back 7
    python tools/fetch_google_reviews.py --brand_id carisma_aesthetics --output_dir .tmp/reviews/fetched
