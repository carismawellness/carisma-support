#!/usr/bin/env python3
"""
add_hyperlinks_thread-lift.py

Applies real hyperlinks to the Cheek Fillers Malta blog post Google Doc.
Converts 'anchor text [→ URL]' visible link placeholders to real clickable hyperlinks
using the Google Docs API batchUpdate.

Post: AES-01 — Cheek Fillers Malta (August 2026)
Doc ID: 1IxRX1mugXx-UlrMcOGOsbuwqIbpzoda_HIQMGR3zN2o
FINAL.md: .tmp/blog-drafts/aesthetics/august-2026/post-01-thread-lift-FINAL.md
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1IxRX1mugXx-UlrMcOGOsbuwqIbpzoda_HIQMGR3zN2o",
        "title": "AES-01 — Cheek Fillers Malta (August 2026)",
        "final_md": f"{AES_DIR}/post-01-thread-lift-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Cheek Fillers Malta")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1IxRX1mugXx-UlrMcOGOsbuwqIbpzoda_HIQMGR3zN2o/edit")
