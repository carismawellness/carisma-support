#!/usr/bin/env python3
"""
add_hyperlinks_postpartum.py

Converts 'anchor text [→ URL]' visible link placeholders in the Google Doc
for Brief 04 — Postpartum Weight Loss Malta to real clickable hyperlinks
using the Google Docs API batchUpdate.

Usage:
    python tools/add_hyperlinks_postpartum.py
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1_QhTvt5lssUPbiE4b0cln39KxmyrhXQwWL3KbF1aQfc",
        "title": "Post 04 — Postpartum Weight Loss Malta",
        "final_md": f"{BASE_DIR}/FINAL-04-postpartum-weight-loss-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Postpartum Weight Loss Malta")
    print("=" * 60)
    ...
    print(f"Doc URL: https://docs.google.com/document/d/1_QhTvt5lssUPbiE4b0cln39KxmyrhXQwWL3KbF1aQfc/edit")
