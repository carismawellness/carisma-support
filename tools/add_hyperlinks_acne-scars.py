...
Post: AES-03 — Acne Scar Treatment Malta (September 2026)
Doc ID: 1A3W4quJAqeFeLg45k19IVD3PJJkRdWrRRtGXX5nnA34

Usage:
    python3 tools/add_hyperlinks_acne-scars.py
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1A3W4quJAqeFeLg45k19IVD3PJJkRdWrRRtGXX5nnA34",
        "title": "AES-03 — Acne Scar Treatment Malta",
        "final_md": f"{AES_SEP_DIR}/post-03-acne-scars-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: AES-03 Acne Scar Treatment Malta")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1A3W4quJAqeFeLg45k19IVD3PJJkRdWrRRtGXX5nnA34/edit")
