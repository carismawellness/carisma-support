#!/usr/bin/env python3
"""
add_hyperlinks_hot-stone.py

Applies real clickable hyperlinks to the Hot Stone Massage Malta Google Doc.
Converts 'anchor text [→ URL]' visible placeholders to real links using the Docs API.

Doc: Hot Stone Massage Malta: Benefits, Preparation, and What Happens During Your Session | Carisma Spa | July 2026
Doc ID: 1IPDe1n8WJBcfU1S9mTGEcPr84G23SNjRTMNdR0cwm5g
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1IPDe1n8WJBcfU1S9mTGEcPr84G23SNjRTMNdR0cwm5g",
        "title": "SPA-02 (July 2026) — Hot Stone Massage Malta",
        "final_md": f"{BASE_DIR}/FINAL-02-hot-stone-massage-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Hot Stone Massage Malta")
    print("=" * 60)
    ...
    print(f"Doc URL: https://docs.google.com/document/d/1IPDe1n8WJBcfU1S9mTGEcPr84G23SNjRTMNdR0cwm5g/edit")
