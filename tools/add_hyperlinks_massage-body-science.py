#!/usr/bin/env python3
"""
add_hyperlinks_massage-body-science.py

Applies real hyperlinks to the Google Doc for:
  Post 03 — What Happens to Your Body During a Massage? (Carisma Spa, August 2026)

Google Doc ID: 1vl7fkI2B_j7T6aXMzS93T8rpZpVUtkbkTqmIMgmZ_lg
FINAL.md: .tmp/blog-drafts/spa/august-2026/post-03-massage-body-science-FINAL.md
...
Run once. Idempotent (second run will show NOT FOUND — that's expected).
"""
...
BASE_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/spa/august-2026"

DOCS_CONFIG = [
    {
        "doc_id": "1vl7fkI2B_j7T6aXMzS93T8rpZpVUtkbkTqmIMgmZ_lg",
        "title": "Post 03 — What Happens to Your Body During a Massage? (Carisma Spa Aug 2026)",
        "final_md": f"{BASE_DIR}/post-03-massage-body-science-FINAL.md",
    },
]
...
def process_doc(service, doc_id, title, final_md_path):
    ...
    # --- 4. Sort in REVERSE order so deletions do not shift earlier positions ---
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Massage Body Science (Aug 2026)")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1vl7fkI2B_j7T6aXMzS93T8rpZpVUtkbkTqmIMgmZ_lg/edit")
