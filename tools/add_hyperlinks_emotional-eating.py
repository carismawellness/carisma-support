#!/usr/bin/env python3
"""
add_hyperlinks_emotional-eating.py

Converts 'anchor text [→ URL]' visible link placeholders in the Google Doc for:
  [August 2026] Emotional Eating and Weight Loss Malta — Carisma Slimming

to real clickable hyperlinks using the Google Docs API batchUpdate.

Usage:
    python3 tools/add_hyperlinks_emotional-eating.py
...
DOCS_CONFIG = [
    {
        "doc_id": "1yNF6sjMiWd_n-MaBZeWdbosm8p0kjDuhAvWjGNsJ6T8",
        "title": "SLI-04 — Emotional Eating and Weight Loss Malta",
        "final_md": f"{BASE_DIR}/post-04-emotional-eating-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Emotional Eating Post")
    print("=" * 60)
