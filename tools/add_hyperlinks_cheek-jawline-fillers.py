#!/usr/bin/env python3
"""
add_hyperlinks_cheek-jawline-fillers.py

Applies internal hyperlinks to the Google Doc for:
  [August 2026] Cheek Fillers vs Jawline Fillers Malta — Carisma Aesthetics
  Doc ID: 1-Mhaao_RsosD57NiHUtbnV94r2puxPJUPSJRzCB1Fu8
...
Usage:
    python3 tools/add_hyperlinks_cheek-jawline-fillers.py
"""
...
AES_AUG_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/aesthetics/august-2026"

DOCS_CONFIG = [
    {
        "doc_id": "1-Mhaao_RsosD57NiHUtbnV94r2puxPJUPSJRzCB1Fu8",
        "title": "AES-04 — Cheek Fillers vs Jawline Fillers Malta",
        "final_md": f"{AES_AUG_DIR}/post-04-cheek-jawline-fillers-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Cheek vs Jawline Fillers")
    print("=" * 60)
    ...
    print(f"Doc URL: https://docs.google.com/document/d/1-Mhaao_RsosD57NiHUtbnV94r2puxPJUPSJRzCB1Fu8/edit")
