#!/usr/bin/env python3
"""
add_hyperlinks_swedish-massage.py

Converts 'anchor text [→ URL]' visible link placeholders in the Swedish Massage Malta
Google Doc to real clickable hyperlinks using the Google Docs API batchUpdate.

Usage:
    python tools/add_hyperlinks_swedish-massage.py

Reads FINAL.md to extract (anchor_text, url) pairs, then finds
...
DOCS_CONFIG = [
    {
        "doc_id": "1YlDRa3h9yYxCf4Xmj_GJPPAOY1srV1O5i2RcYfz1wqI",
        "title": "SPA-JUL-01 — Swedish Massage Malta",
        "final_md": f"{BASE_DIR}/FINAL-01-swedish-massage-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Swedish Massage Malta")
    print("=" * 60)
    ...
    print(f"Doc URL: https://docs.google.com/document/d/1YlDRa3h9yYxCf4Xmj_GJPPAOY1srV1O5i2RcYfz1wqI/edit")
