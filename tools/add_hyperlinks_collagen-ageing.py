#!/usr/bin/env python3
"""
add_hyperlinks_collagen-ageing.py

Applies real hyperlinks to the Google Doc for:
  [August 2026] Collagen Loss and Skin Ageing Malta — Carisma Aesthetics

Converts 'anchor text [→ URL]' visible link placeholders to real clickable
hyperlinks using the Google Docs API batchUpdate.

Usage:
    python3 tools/add_hyperlinks_collagen-ageing.py

Doc ID: 17TjAo0A4_h89HEzhzeruYsZ92QyW52OBsa-YJ5H874s
FINAL.md: .tmp/blog-drafts/aesthetics/august-2026/post-03-collagen-ageing-FINAL.md
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "17TjAo0A4_h89HEzhzeruYsZ92QyW52OBsa-YJ5H874s",
        "title": "AES-03 Aug2026 — Collagen Loss and Skin Ageing Malta",
        "final_md": f"{AES_AUG_DIR}/post-03-collagen-ageing-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Collagen Ageing Post")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/17TjAo0A4_h89HEzhzeruYsZ92QyW52OBsa-YJ5H874s/edit")
