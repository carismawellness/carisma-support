#!/usr/bin/env python3
"""
add_hyperlinks_rf-microneedling.py

Applies real hyperlinks to the RF Microneedling Malta Google Doc.
Post: [August 2026] RF Microneedling Malta — Carisma Aesthetics
Doc ID: 1mzgaVX6SmvAJVcu6uoIb6s0FEoZoGW1xOYmQ5DbzJzs
...
Usage:
    python3 tools/add_hyperlinks_rf-microneedling.py
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1mzgaVX6SmvAJVcu6uoIb6s0FEoZoGW1xOYmQ5DbzJzs",
        "title": "AES-02 — RF Microneedling Malta (August 2026)",
        "final_md": f"{AES_AUG_DIR}/post-02-fat-dissolving-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — RF Microneedling Malta — Add Hyperlinks")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1mzgaVX6SmvAJVcu6uoIb6s0FEoZoGW1xOYmQ5DbzJzs/edit")
