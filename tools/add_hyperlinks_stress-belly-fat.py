#!/usr/bin/env python3
"""
add_hyperlinks_stress-belly-fat.py
...
Usage:
    python3 tools/add_hyperlinks_stress-belly-fat.py
...
DOCS_CONFIG = [
    {
        "doc_id": "1_MCjszL-kgcPwAK1fxAB4bND655BGF_p4wmXGbL90Gc",
        "title": "SLI-SEP-03 — Stress Belly Fat / Cortisol Malta",
        "final_md": f"{SLI_DIR}/post-03-stress-belly-fat-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Stress Belly Fat Post")
    print("=" * 60)
    ...
    print(f"Doc URL: https://docs.google.com/document/d/1_MCjszL-kgcPwAK1fxAB4bND655BGF_p4wmXGbL90Gc/edit")
