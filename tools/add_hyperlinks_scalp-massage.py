#!/usr/bin/env python3
"""
add_hyperlinks_scalp-massage.py

Converts 'anchor text [→ URL]' visible link placeholders in the Google Doc
for Post 04 — Scalp Massage Benefits (Carisma Spa, September 2026) to real
clickable hyperlinks using the Google Docs API batchUpdate.

Usage:
    python3 tools/add_hyperlinks_scalp-massage.py
...
SEP_DIR = "/Users/mertgulen/Library/CloudStorage/GoogleDrive-mertgulen98@gmail.com/My Drive/Carisma Wellness Group/Carisma AI /Carisma AI/.tmp/blog-drafts/spa/september-2026"

DOCS_CONFIG = [
    {
        "doc_id": "1py_fyuddW8Bn4EGY9_VVEUnYzaT2ee2udW5s9tXr8c0",
        "title": "SPA-04 — Scalp Massage Benefits Malta",
        "final_md": f"{SEP_DIR}/post-04-scalp-massage-FINAL.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: SPA-04 Scalp Massage Benefits")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1py_fyuddW8Bn4EGY9_VVEUnYzaT2ee2udW5s9tXr8c0/edit")
