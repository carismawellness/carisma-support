#!/usr/bin/env python3
"""
add_hyperlinks_insulin-resistance.py

Applies real clickable hyperlinks to the Carisma Slimming insulin resistance
blog post Google Doc (August 2026 batch, Post 02).

Reads the FINAL.md file to extract (anchor_text, url) pairs, then finds
each 'anchor text [-> URL]' occurrence in the Google Doc and applies
real hyperlinks via batchUpdate. Processes in reverse doc order so
deletions do not shift earlier positions.

Google Doc ID: 1pp8T_eIt0slKHUcmVzTBbO8qYccpriZtsCqs_Rj4Z10
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1pp8T_eIt0slKHUcmVzTBbO8qYccpriZtsCqs_Rj4Z10",
        "title": "SLI-AUG-02 — Insulin Resistance Weight Loss Malta",
        "final_md": f"{SLI_DIR}/post-02-insulin-resistance-FINAL.md",
    },
]
...
def find_link_occurrences(flat_text, index_map, anchor, url):
    ...
    # Handle both Unicode arrow (U+2192) and ASCII -> (older doc format)
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Insulin Resistance Post")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1pp8T_eIt0slKHUcmVzTBbO8qYccpriZtsCqs_Rj4Z10/edit")
