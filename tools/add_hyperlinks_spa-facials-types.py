#!/usr/bin/env python3
"""
add_hyperlinks_spa-facials-types.py

Applies real clickable hyperlinks to the Google Doc:
  [August 2026] Types of Spa Facials Malta — Carisma Spa
  Doc ID: 1Xv9u2KZIV598fEIg2wEj51qNzRMWUMYub7nnlBYzQP0

Converts 'anchor text [→ URL]' visible placeholders to real links
using the Google Docs API batchUpdate.

Generated from: tools/add_docs_hyperlinks.py
Post: post-01-spa-facials (August 2026)
...
DOCS_CONFIG = [
    {
        "doc_id": "1Xv9u2KZIV598fEIg2wEj51qNzRMWUMYub7nnlBYzQP0",
        "title": "SPA-01 (Aug 2026) — Types of Spa Facials Malta",
        "final_md": f"{BASE_DIR}/post-01-spa-facials-FINAL.md",
    },
]
...
def main():
    ...
    print("Post: Types of Spa Facials Malta (August 2026)")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/1Xv9u2KZIV598fEIg2wEj51qNzRMWUMYub7nnlBYzQP0/edit")
