#!/usr/bin/env python3
"""
add_hyperlinks_spa-party.py

Converts 'anchor text [→ URL]' visible link placeholders in the Google Doc
for "How to Plan the Perfect Spa Party in Malta" to real clickable hyperlinks
using the Google Docs API batchUpdate.

Post: SPA-03 (July 2026) — How to Plan the Perfect Spa Party in Malta
Doc ID: 1Jy8sxLdfxAW_jeIQH8Gd2jZzrcD9iDIZzfGeiixG80I
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "1Jy8sxLdfxAW_jeIQH8Gd2jZzrcD9iDIZzfGeiixG80I",
        "title": "SPA-03 (July 2026) — How to Plan the Perfect Spa Party in Malta",
        "final_md": f"{BASE_DIR}/FINAL-03-spa-party-malta.md",
    },
]
...
def main():
    ...
    print("Post: SPA-03 (July 2026) — Spa Party Malta")
    print("=" * 60)
