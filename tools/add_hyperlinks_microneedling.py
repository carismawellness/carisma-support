#!/usr/bin/env python3
"""
add_hyperlinks_microneedling.py

Applies real hyperlinks to the Microneedling Malta blog post Google Doc.
Converts 'anchor text [→ URL]' visible link placeholders to real clickable hyperlinks.

Usage:
    python tools/add_hyperlinks_microneedling.py
"""
...
DOCS_CONFIG = [
    {
        "doc_id": "11Lz4YG8ssPALptUeS0xQJ0Kt3Zcd2vkpMuWC7b1DvGw",
        "title": "AES-JUL-01 — Microneedling Malta",
        "final_md": f"{BASE_DIR}/FINAL-01-microneedling-malta.md",
    },
]
...
def main():
    print("=" * 60)
    print("Carisma Blog — Add Hyperlinks: Microneedling Malta")
    print("=" * 60)
    ...
    print("Doc URL: https://docs.google.com/document/d/11Lz4YG8ssPALptUeS0xQJ0Kt3Zcd2vkpMuWC7b1DvGw/edit")
